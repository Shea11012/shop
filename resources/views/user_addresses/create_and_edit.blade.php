                ...
                <div class="card-body">
                    ...
                    <user-addresses-create-and-edit inline-template>
                        ...
                        @endif
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-control" v-model="provinceId">
                                                ...
                                                <option v-for="(name,id) in provinces" :id="name" :value="id">@{{ name
                                                                                                              }}
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-control" v-model="cityId">
                                                ...
                                                <option v-for="(name,id) in cities" :id="name" :value="id">@{{ name }}
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-sm-3">
                                            <select class="form-control" v-model="districtId">
                                                ...
                                                <option v-for="(name,id) in districts" :id="name" :value="id">@{{ name
                                                                                                              }}
                                                </option>
                                            </select>
                                        </div>
                                ...
                                {{-- 插入 3 个隐藏字段--}}
                                {{-- 通过 v-model  与 create-and-edit 组件关联 --}}
